...
* a version-control interchange checkout (mostly used by developers)
...
# revision-control interchange data, or from the parent directory name of an
...
def do_setup():
    ...
    ipy = os.path.join(
        os.path.dirname(cfg.versionfile_source),
        "__init__.py",
    )
