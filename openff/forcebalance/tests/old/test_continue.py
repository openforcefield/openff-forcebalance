...
class TestWaterTutorial(ForceBalanceTestCase):
    def setup_method(self, method):
        ...
        shutil.copytree(
            os.path.join(source_folder, "forcefield"),
            os.path.join(tmpfolder, "forcefield"),
        )
        shutil.copytree(
            os.path.join(source_folder, "targets"), os.path.join(tmpfolder, "targets")
        )
        ...
        shutil.copytree(
            os.path.join(files_folder, "test_continue.tmp"),
            os.path.join(tmpfolder, "test_continue.tmp"),
        )
        os.chdir(tmpfolder)
