...
from openff.forcebalance.amberio import parse_amber_namelist, splitComment
...
class TestSplitComment:
    def test_split_comment(self):
        ...
        test_input_output(
            " restraint_wt=0.1, ! Restraint force constant ", " restraint_wt=0.1, "
        )

        # Exclamation marks enclosed in quote
        test_input_output(
            " restraintmask='!:WAT,NA&!@H=', ! This is a comment",
